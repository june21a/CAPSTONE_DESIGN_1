...
torchrun --nnodes=1 --nproc_per_node=1 --max_restarts=0 --rdzv_id=$SLURM_JOB_ID --rdzv_backend=c10d \
    train.py --id pretrained_dynamic_plan_safety_head_dataset_10e_0618 --use_disk_cache 0 --crop_image 1 --seed 0 --epochs 10 --batch_size 32 --lr 3e-4 --setting all \
    ...
    --use_mode_prediction 1 --mode_prediction_type plan_safety_dynamic --plan_safety_labeled_frames_only 1 \
    --plan_safety_loss_weights 1.5 1.0 --freeze_backbone 1 --freeze_except_mode_prediction_network 1 \
